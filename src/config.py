"""
Configuration settings for BareMetal Match.
...
DEFAULT_JOB_ROLE = "Embedded Software Engineer"
...
# Data directory for the personal application tracker (see track.py).
# This is your own application history, so it's gitignored by default —
# see .gitignore's "data/" entry.
...
def print_config() -> None:
    ...
    """
    print("\n" + "="*70)
    print("BAREMETAL MATCH - CONFIGURATION")
    print("="*70)
    print(f"\n📋 Job Search Settings:")
